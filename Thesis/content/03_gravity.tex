...
\caption[Vacuum polarization diagrams ($E=2$) up to $1$-loop order.]{Vacuum polarization diagrams ($E=2$) up to $1$-loop order. The double lines represent the graviton propagator.}	
