...
\draw[thick, dotted, decoration={markings, mark=at position 0.5 with {\arrow{<}}}, postaction={decorate}] circle(0.7);
\draw[thick, dotted, decoration={markings, mark=at position 0.007 with {\arrow{<}}}, postaction={decorate}] circle(0.7);
\node [draw, fill = white, circle, cross, minimum width= 0.1 cm] at (0,0.7){}; 
\end{tikzpicture}
